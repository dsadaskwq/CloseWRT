...
#删除自带核心packages 
rm -rf $(find ../feeds/packages/ -type d -regex ".*\(zerotier\|samba4\|alist\|golang\|mosdns\|chinadns-ng\|sing-box\|xray-core\|v2ray-core\|v2ray-plugin\|v2ray-geodata\|aliyundrive-webdav\).*")
